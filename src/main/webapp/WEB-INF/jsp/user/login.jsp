...
<form id="user" action="${pageContext.request.contextPath}/user/login" method="POST">
    ...
    &nbsp;&nbsp;&nbsp;
    <button type="button" onclick="location.href = '${pageContext.request.contextPath}/user/register'" class="btn btn-primary">注册账号</button>
</form>
